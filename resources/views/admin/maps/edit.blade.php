                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <div class="input-group input-group-merge">
                        ...
                        <input type="number" id="deaths" class="form-control @error('deaths') is-invalid @enderror"
                          name="deaths" placeholder="Jumlah korban yang meninggal" step="1" min="0"
                          value="{{ $map->deaths }}">
                        @error('deaths')
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <div class="input-group input-group-merge">
                        ...
                        <input type="number" id="injured" class="form-control @error('injured') is-invalid @enderror"
                          name="injured" placeholder="Jumlah korban yang mengalami luka kecil/berat" step="1" min="0"
                          value="{{ $map->injured }}">
                        @error('injured')
                        <div class="invalid-feedback">
                          {{ $message }}
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <div class="input-group input-group-merge">
                        ...
                        <input type="number" id="losts" class="form-control @error('losts') is-invalid @enderror"
                          name="losts" placeholder="Jumlah korban yang hilang" step="1" min="0"
                          value="{{ $map->losts }}">
                        @error('losts')
                        <div class="invalid-feedback">
                          {{ $message }}
                      ...
                      <div class="col-md-8">
                        <div class="form-group">
                          <div class="input-group input-group-merge">
                            ...
                            <input class="form-control" placeholder="Pilih tanggal awal kejadian" type="text"
                              name="date_in" id="date_in" value="{{ date('m/d/Y', strtotime($map->date_in))}}"
                              onchange="setDateOut()">
                            @error('date')
                            <div class="invalid-feedback">
                              {{ $message }}
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <div class="input-group input-group-merge">
                            ...
                            <input class="form-control" type="time" value="{{ date('H:i', strtotime($map->date_in))}}"
                              id="example-time-input" name="date_in_time">
                            @error('time')
                            <div class="invalid-feedback">
                              {{ $message }}
                            </div>
                      ...
                      <div class="col-md-8">
                        <div class="form-group">
                          <div class="input-group input-group-merge">
                            ...
                            <input class="form-control date_out" placeholder="Pilih tanggal kejadian berakhir"
                              type="text" name="date_out" id="date_out"
                              value="{{ date('m/d/Y', strtotime($map->date_out))}}">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <div class="input-group input-group-merge">
                            ...
                            <input class="form-control" type="time" value="{{ date('H:i', strtotime($map->date_out))}}"
                              id="example-time-input" name="date_out_time">
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <button type="button" class="btn btn-info" data-toggle="tooltip" data-placement="top"
                        title="Button ini berfungsi mengaktifkan tanggal berakhir banjir atau tidak"
                        onclick="setDateOutField()" id="btn-set-date-out">Atur tanggal berakhirnya banjir</button>
                    </div>
                  </div>
                        ...
                        <div class="form-group">
                          <div class="input-group input-group-merge">
                            <input type="text" id="district" class="form-control"
                              name="locations[{{ $indexLocation }}][]" placeholder="Lokasi Kecamatan"
                              value="{{ $locations->district }}" readonly>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="form-group">
                          <div class="input-group input-group-merge">
                            <input type="text" id="village" class="form-control"
                              name="locations[{{ $indexLocation }}][]" placeholder="Lokasi Kelurahan"
                              value="{{ $locations->village }}" readonly>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-1">
                        <div class="form-group">
                          <button type="button" class="btn btn-danger"
                            onclick="btnCLoseLocations('add-locations-{{ $indexLocation }}')"><i
                    ...
                    <div class="form-group">
                      <div class="input-group input-group-merge">
                        <button type="button" class="btn btn-info" data-toggle="modal"
                          data-target="#modal-add-address">Tambahkan Rincian Lokasi</button>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <div class="input-group input-group-merge">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror"
                          placeholder="Kronologi" name="description"
                          id="description">{!! $map->description !!}</textarea>
                        @error('description')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                  ...
                  <div class="col-md-12">
                    <div class="input-group">
                      ...
                      <div style="position:relative;padding-right: 20px; padding-bottom: 20px"
                        id="mapImage-{{$item->id}}">
                        <button type="button" class="close topRight" aria-label="Close"
                          onclick="deleteImage('{{ $item->id }}')">
                          <i class="fas fa-times"></i></span>
                        </button>
                        <a href="{{ url('/storage'.'/'.$item->src) }}" data-rel="lightcase:myCollection">
                          <img class="img-fluid rounded" src="{{ url('/storage'.'/'.$item->src) }}"
                            alt="{{ $map->name }}" width="150px;">
                        </a>
                      </div>
                      @endforeach
                    </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group row">
                      <label for="example-text-input" class="col-md-2 col-form-label form-control-label">Level
                        Banjir</label>
                      <div class="col-md-10">
                        <select name="level" id="level" class="form-control" data-toggle="select">
                          <option value=""></option>
                          @foreach($levels as $level)
                          <option value="{{ $level['id'] }}" {{ $level['id']==$map->level ? 'selected' : '' }} title="{{
                            $level['desc'] }}">{{ $level['name'] }}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
                  ...
                  <div class="col-md-12" id="status-form">
                    <div class="form-group row">
                      <label for="example-text-input" class="col-md-2 col-form-label form-control-label">Status
                        Penerbitan</label>
                      <div class="col-md-10">
